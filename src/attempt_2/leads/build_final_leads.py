...
TRIBAL = ["TRIBE","TRIBES","TRIBAL","RANCHERIA","PUEBLO","NATION","BAND OF","NATIVE AMERICAN","INDIAN HEALTH",
    "INDIAN NATION","INDIAN TRIBE","INDIAN COMMUNITY","REGIONAL HEALTH CONSORTIUM","NATIVE ASSOCIATION","ALASKA NATIVE"]
PUBLIC_ACADEMIC = ["UNIVERSITY","REGENTS OF","BOARD OF REGENTS","STATE COLLEGE","COLLEGE OF MEDICINE"]
# GATE-4 hardening (labels track): institutional categories the keyword screens missed.
SCHOOL = ["SCHOOL DISTRICT","UNIFIED SCHOOL","PUBLIC SCHOOL","PUBLIC SCHOOLS","BOARD OF EDUCATION",
    "COMMUNITY SCHOOL","CHARTER SCHOOL","SCHOOL CORPORATION","INDEPENDENT SCHOOL","COUNTY SCHOOLS",
    "AREA SCHOOLS","CITY SCHOOLS","ISD"]
ACADEMIC_SAFETYNET = ["FACULTY","MEDICAL COLLEGE","MEDICAL FACULTY","UNIVERSITY PHYSICIANS",
    "ACADEMIC MEDICINE","DISTRICT MEDICAL GROUP"]
SCHOOL_TAX = {"251300000X"}   # Local Education Agency
...
NAME_RULES = [("government", GOVERNMENT), ("tribal", TRIBAL), ("public_academic", PUBLIC_ACADEMIC),
              ...
              ("school", SCHOOL), ("academic_safetynet", ACADEMIC_SAFETYNET)]
